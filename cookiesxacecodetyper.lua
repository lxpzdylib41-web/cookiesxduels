...
makeLabel(Header, "Title", "COOKIES HUB SNIPER X ACE DUELS", UDim2.fromOffset(180, 25), UDim2.fromOffset(56, 17), 15, COLORS.White, Enum.Font.GothamBold)
...
local DiscordFooter = makeLabel(Window, "DiscordFooter", "https://discord.gg/H4zXY756F", UDim2.fromOffset(140, 19), UDim2.new(0.5, -70, 0, 346), 10, COLORS.White, Enum.Font.GothamBold)
